...
**Platform overview** — GitHub Actions → Artifact Registry → Argo CD → private GKE → Gateway API → observability. See [docs/diagrams/infrastructure-diagram.png](docs/diagrams/infrastructure-diagram.png) for the full diagram (Medium/LinkedIn hero).
