...
![Terraform workflow: validate, plan-apply, and security jobs succeeded](../diagrams/github-actions-terraform-workflow-success.png)

**Terraform workflow — validate, plan-apply, and security jobs succeeded**
...
2. Watch the job steps:
   ...
   ![CI frontend: build-scan-push job succeeded](../diagrams/github-actions-ci-frontend-build-scan-push.png)

   **CI frontend — build, scan, and push to Artifact Registry**
