...
> **Note:** Manifests ship with placeholders (`YOUR_PROJECT_ID`, `YOUR_GITHUB_ORG`, `boutique.example.com`). Replace them with your values in [Phase 2 — GitHub setup](docs/implementation/phase-02-github-setup.md).

![GCP platform architecture — Online Boutique on GKE](docs/diagrams/infrastructure-diagram.png)

## License

This repository is licensed under the [Apache License 2.0](LICENSE). Application source under `apps/` includes Google LLC copyright notices from the upstream microservices-demo project.
...
8. [Phase 7 — Teardown](docs/implementation/phase-07-teardown.md)

## Sibling projects

| Repo | Cloud | CI | Notes |
|------|-------|-----|-------|
| [micser-apps-AWS-Terraform-Helm-GitOps-monitoring](https://github.com/btilki/micser-apps-AWS-Terraform-Helm-GitOps-monitoring) | EKS | GitLab | Single Helm chart, upstream images |
| [micser-apps-Azure-Terraform-Helm-GitOps-monitoring](https://github.com/btilki/micser-apps-Azure-Terraform-Helm-GitOps-monitoring) | AKS | Azure DevOps | Per-service charts, scaffold images |
| **[micser-apps-GCP-Terraform-Helm-GitOps-monitoring](https://github.com/btilki/micser-apps-GCP-Terraform-Helm-GitOps-monitoring)** (this repo) | GKE | GitHub Actions | GCP-native ingress/observability, real app source |
